...
class DataProvider extends ChangeNotifier {
  ...
  DateTime currentDate = DateTime.now().subtract(Duration(days: 1)); // Default: yesterday
  List<HR> heartRates = [];
  ...
  List<Calories> getCalories(DateTime date) => _cachedCalories[_dateKey(date)] ?? [];
  List<Exercise> getExercises(DateTime date) => _cachedExercises[_dateKey(date)] ?? [];
